...
export default function TaskListCard({ task }: TaskListCardProps) {
  ...
  return (
    <Link
      href={`/tasks/${task.id}`}
      className="group block rounded-[20px] p-5 bg-white/[0.02] border border-white/[0.04] border-t-white/[0.08] hover:bg-white/[0.04] hover:border-white/[0.08] transition-all duration-200 active:scale-[0.98]"
    >
