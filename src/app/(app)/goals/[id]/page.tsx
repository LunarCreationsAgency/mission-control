    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <h1 className="text-2xl font-semibold text-[var(--foreground)]">{goal.name}</h1>
        </div>
        <div className="flex items-center gap-1.5">
          <button onClick={() => setEditModalOpen(true)}
            className="flex items-center gap-1.5 rounded-lg border border-[var(--border)] px-3 py-2 text-xs font-medium text-[var(--foreground-secondary)] hover:bg-[var(--surface-hover)] hover:border-[var(--border-hover)] transition-all"
          >
            <Pencil className="h-3 w-3" /> Edit
          </button>
          {!deleteConfirm ? (
            <button onClick={() => setDeleteConfirm(true)}
              className="flex items-center gap-1.5 rounded-lg border border-[var(--border)] px-3 py-2 text-xs font-medium text-[var(--foreground-tertiary)] hover:bg-[var(--destructive-subtle)] hover:border-[var(--destructive-border)] hover:text-[var(--destructive)] transition-all"
            >
